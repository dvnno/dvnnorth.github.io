  ...
  $(document).ready(function () {
    ...
    $(".portfolio-image").click(function (event) {
      ...
      $.get(url, function (project) {
        ...
        $("#modal-repo-link").attr("href", project.repo_url);
        let $mdl = $("#modal-deployed-link");
        if (project.deployed_url) {
          if ($mdl.hasClass("hide")) {
            $mdl.removeClass("hide");
          }
          $mdl.attr("href", project.deployed_url);
        }
        else {
          if (!$mdl.hasClass("hide")) {
            $mdl.addClass("hide");
        ...
        $("#modal-project-description").text(project.description);
